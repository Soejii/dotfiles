...
## 4. Peer review the set

Load [`peer-review`](../peer-review/SKILL.md) and follow it, scoped to every path
across the planned commits. Docs-only or config-only diffs skip it; say you
skipped it and why.
...
Report what each commit contains, what stayed uncommitted and why, and what the
review flagged.
